...
echo "✓ Pre-commit test hook installed successfully!"
echo ""
echo "The hook will run Wiki Service tests before every 'git commit'."
echo "To skip the hook: git commit --no-verify"
echo ""
echo "Note: Tests run after formatting/linting checks."
