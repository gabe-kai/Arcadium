...
def test_get_orphanage_orphaned_from_none(client, app, test_user_id):
    ...
    orphan_data = next((p for p in data['pages'] if p['slug'] == 'orphan-no-parent'), None)
...
def test_reassign_orphaned_pages_invalid_new_parent(client, app, test_user_id, test_admin_id):
...
def test_reassign_orphaned_pages_partial_success(client, app, test_user_id, test_admin_id):
