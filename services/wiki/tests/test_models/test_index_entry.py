...
def test_index_entry_creation(app):
    ...
    with app.app_context():
        ...
        assert entry.is_keyword == False
        assert entry.is_manual == False
...
def test_fulltext_vs_keyword_entries(app):
    ...
    with app.app_context():
        ...
        assert fulltext_entry.is_keyword == False
        assert fulltext_entry.position == 5
        assert keyword_entry.is_keyword == True
