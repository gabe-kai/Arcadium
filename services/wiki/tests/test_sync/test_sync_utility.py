...
def test_should_sync_file_newer_than_db(temp_pages_dir, app, sync_utility, admin_user_id):
...
def test_should_sync_file_older_than_db(temp_pages_dir, app, sync_utility, admin_user_id):
...
def test_sync_directory(temp_pages_dir, app, sync_utility, admin_user_id):
    ...
    with app.app_context():
        ...
        # Files in section1
        with open(os.path.join(temp_pages_dir, 'section1', 'page1.md'), 'w', encoding='utf-8') as f:
            f.write('---\ntitle: "Page 1"\nslug: "page-1"\n---\n\n# Page 1')
        
        # Files in section2 (should not be synced)
        with open(os.path.join(temp_pages_dir, 'section2', 'page2.md'), 'w', encoding='utf-8') as f:
            f.write('---\ntitle: "Page 2"\nslug: "page-2"\n---\n\n# Page 2')
