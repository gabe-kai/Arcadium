...
def test_handle_slug_change(app):
    ...
    with app.app_context():
        ...
        # Change page2's slug
        PageService.update_page(page_id=page2.id, user_id=user_id, slug="new-page-2")
        ...
        assert (
            "page-2" not in page1.content or "page-2" in page1.content
        )  # May still be in old content
