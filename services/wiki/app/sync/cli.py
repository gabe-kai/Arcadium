...
def main():
    ...
    parser_all.add_argument('--force', action='store_true', help='Force sync even if file is not newer')
    parser_all.add_argument('--admin-user-id', help='Admin user UUID to assign pages to')
    
    # sync-file command
    parser_file = subparsers.add_parser('sync-file', help='Sync a specific file')
    parser_file.add_argument('file_path', help='Relative file path (e.g., section/page.md)')
    parser_file.add_argument('--force', action='store_true', help='Force sync even if file is not newer')
    parser_file.add_argument('--admin-user-id', help='Admin user UUID to assign pages to')
    
    # sync-dir command
    parser_dir = subparsers.add_parser('sync-dir', help='Sync all files in a directory')
    parser_dir.add_argument('directory', help='Directory path (relative to pages directory)')
