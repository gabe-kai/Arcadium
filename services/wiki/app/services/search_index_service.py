...
class SearchIndexService:
    ...
    @staticmethod
    def index_page(page_id: uuid.UUID, content: str, title: str = None) -> List[IndexEntry]:
        """
        ...
        keyword_entries = SearchIndexService._create_keyword_entries(
            page_id, full_text
        )
    ...
    def search_by_keyword(keyword: str) -> List[Page]:
        ...
        entries = IndexEntry.query.filter_by(
            term=keyword,
            is_keyword=True
        ).all()
