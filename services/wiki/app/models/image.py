...
class Image(db.Model):
    ...
    uuid = Column(String(255), unique=True, nullable=False, index=True)  # UUID used in filename
    ...
    # Relationships
    pages = relationship('PageImage', back_populates='image', cascade='all, delete-orphan')
